...
class Distance {
    ...
    public double DotProduct() {
    	HashMap<String, Integer> dict1 = doc_1.frequency(); 	
    	HashMap<String, Integer> dict2 = doc_2.frequency(); 	
        String key;
        int sum = 0;
    ...
    public double similarity() {
        double a = Euclidean(doc_1);
        double b = Euclidean(doc_2);
        double num = a*b;
